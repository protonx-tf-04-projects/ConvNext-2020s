...
def build_patchify(input_shape, num_classes, layers, model_name):
  ...
  if model_name == 'resrext':
        filters=[384,96,384,768]
  elif model_name == 'invertedbottleneck':
        filters=[96,384,96,768]
  elif model_name == 'largekenel':
        filters=[96,384,96,768]
  else:
        filters=[64,128,256,512]
